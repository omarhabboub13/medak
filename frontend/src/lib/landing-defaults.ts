...
type LandingDefaults = Omit<LandingContent, "id" | "updatedAt">;
...
export const defaultLandingByLocale: Record<Locale, LandingDefaults> = {
  ar: {
    brandName: "مدك",
    brandNameEn: "Medak",
    ...
    doctorsIntro: "يوفّر مدك لوحة متكاملة للأطباء لإدارة عياداتهم الرقمية.",
    doctorFeatures: [
...
export function getLandingFallback(locale: Locale): LandingContent {
  return {
    id: locale,
    ...defaultLandingByLocale[locale],
  };
}
